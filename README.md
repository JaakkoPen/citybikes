This project is focused on analysing Helsinki City bike data with R programming and Python. These scripts include functions which calculate the most used bike stations,
